...
curl --connect-timeout 5 --max-time 600 --retry 5 --retry-delay 0 --retry-max-time 60 -o /tmp/coreutils.tar.xz -L "https://github.com/rcannizzaro/arch-packages/raw/master/compiled/x86-64/coreutils.tar.xz"
